 ...
 * @version 4.0.0
 */
public class ProgressReporter implements RenderEventListener {
	...
	public void done() {
		lock.lock();
		finishedTime = (System.currentTimeMillis() - startTime) * 0.001;
		done = totalWork;
	...
	public void finished(Tile tile) {
		this.update(tile.getWidth() * tile.getHeight());
	}
